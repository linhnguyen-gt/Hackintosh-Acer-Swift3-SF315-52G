...
- Include [[https://github.com/OpenIntelWireless/IntelBluetoothFirmware/releases][IntelBluetoothFirmware]] for Bluetooth (for installation to CLOVER/kexts/Other)
